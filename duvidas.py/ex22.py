    ...
    def carregar_estoque(self, nome_arquivo):
        if os.path.exists(nome_arquivo):
            with open(nome_arquivo, 'r') as file:
                data = json.load(file)
                self.veiculos = [Veículo(**veiculo) for veiculo in data]
...
def exibir_menu():
    print(Fore.CYAN + "\n===== Menu Principal ======")
    print(Fore.WHITE + "1. Listar os veículos disponíveis")
    print(Fore.WHITE + "2. Adicionar veículo ao estoque")
    print(Fore.WHITE + "3. Buscar veículo por modelo")
    print(Fore.WHITE + "4. Vender veículo")
    print(Fore.WHITE + "5. Calcular lucro total")
    print(Fore.WHITE + "6. Listar veículos vendidos")
    print(Fore.WHITE + "7. Aplicar desconto em veículo")
    print(Fore.WHITE + "8. Salvar estoque em arquivo")
    print(Fore.WHITE + "9. Carregar estoque do arquivo")
    print(Fore.WHITE + "10. Fazer backup do estoque")
    print(Fore.WHITE + "11. Sair do sistema")
...
def adicionar_veiculo(estoque):
    ...
    veiculo = Veículo(marca, modelo, ano, preco, tipo)
...
def main():
    ...
    while True:
        ...
        if escolha == '1':
            ...
            print(Fore.CYAN + "Saindo do sistema. Obrigado por utilizar o nosso sistema. Até mais! 🚪")
