...
class Campeonato:
    ...
    def salvar_dados(self, arquivo):
        ...
        with open(arquivo, 'w') as f:
            json.dump(dados, f, indent=4, default=self.json_default)  # Usamos default=self.json_default para serializar artilheiros
    ...
    def json_default(self, obj):
        if isinstance(obj, dict) and 'time' in obj and 'gols' in obj:
            return {'time': obj['time'], 'gols': obj['gols']}
